-- Fix the approve_submission function to correctly read from the structured payload
  ...
  CASE v_submission.type
    WHEN 'event' THEN
      ...
      VALUES (
        ...
        -- Core sensory fields from payload
        ...
        -- Event-specific environment fields
    ...
    WHEN 'park', 'playground' THEN
      -- Insert into parks or playgrounds table
...
COMMENT ON FUNCTION approve_submission IS 'Promotes a pending submission to its final table with proper field mapping from sensory_features JSONB payload';
