    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>List a sensory-friendly event for families to discover</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              ...
              <Input
                ...
                placeholder="Sensory-Friendly Movie Night"
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Describe your event, what makes it sensory-friendly, and what families can expect..."
                rows={6}
