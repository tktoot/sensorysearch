    ...
    try {
      ...
      const response = await fetch("/api/submissions", {
        ...
        body: JSON.stringify({
          ...
          parkFeatures: sensoryData.parkFeatures,
          images,
        }),
      })
    ...
    <div className="container mx-auto px-4 py-8 max-w-3xl pb-24">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>List a free community park or playground (always free to submit)</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Describe the park, what makes it sensory-friendly, and what families can expect..."
                rows={6}
